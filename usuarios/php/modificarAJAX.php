...
if ($nombre == "" || $login == "" || $correo == "") {
    ...
    if ($password != "") {
        ...
        $queryModificar = "UPDATE usuarios SET nombreusuario = '" . $login . "' , passwordusuario = md5('" . $password . "')  , correo = '" . $correo . "' , nombre = '" . $nombre . "' WHERE idusuario = " . $id . " AND estadoid=1 ";
    } else {

        $queryModificar = "UPDATE usuarios SET nombreusuario = '" . $login . "'  , correo = '" . $correo . "' , nombre = '" . $nombre . "' WHERE idusuario = " . $id . " AND estadoid=1 ";
    }
